...
public class CommonThreadLocalBean {
	private static ThreadLocal<Map<String, Object>> jwtInfoThread = new ThreadLocal<Map<String, Object>>();
	...
	public static Map<String, Object> getUserInfo() throws JWTInvalidException {
		Map<String, Object> ui = (Map<String, Object>) getJwtInfo().get("userInfo");
		if (ui == null) {
	...
	public static String getTimezone() throws JWTInvalidException {
		...
		try {
			Object tz = getJwtInfo().get("hrtimezone");
			if (tz == null) {
				retStr = "GMT+9:00";
			} else {
				retStr = (String) tz;
	...
	public static long getTimezonelong() throws JWTInvalidException {
		...
		try {
			Object tz = getJwtInfo().get("hrtimezonelong");
			if (tz == null) {
				retLong = 9;
			} else {
				retLong = (Long) tz;
	...
	public static String getBrowser() {
		String userAgent = (String) getJwtInfo().get("User-Agent");
		String browser = "";
